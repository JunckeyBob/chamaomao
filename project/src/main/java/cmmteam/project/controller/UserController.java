        ...
        try {
            ...
            if (authentication != null && authentication.isAuthenticated() &&
                ...
                System.out.println("UserController: Authentication principal in session: " +
                        ((org.springframework.security.core.context.SecurityContext)session.getAttribute(HttpSessionSecurityContextRepository.SPRING_SECURITY_CONTEXT_KEY)).getAuthentication().getPrincipal()
                );


            } else {
                System.err.println("UserController: Authentication not found or not truly authenticated in SecurityContextHolder after loginUser call. This is unexpected.");
