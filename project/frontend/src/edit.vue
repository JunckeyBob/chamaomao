...
<!-- main content -->
  <div class="home-container">
    ...
    <div class="button-container">
      ...
      <button class="op-button" @click="router.push('/home')"><i class="fa-solid fa-xmark"></i>&nbsp;取消</button>
    </div>
...
const  AddCatInfo = () => {
    ...
    let id = 0
    axios.post(url, {name:name.value, species:"猫", breed:breed.value, gender:"FEMALE", healthStatus:status.value, basicinfo:basicinfo.value, catsnality:catsnality.value, age:'3'}).then(res=>{
      if(res.status == 201){
          if(!file.value) router.push('/home')
          console.log(res.data)
          console.log(res.data.animalId)
          url = url + "/" + res.data.animalId + "/photos"
